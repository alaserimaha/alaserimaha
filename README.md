...
- **LMS Platform** — A multi-tenant Learning Management System built with Laravel 12, Inertia.js, and Vue 3. Supports online courses, trainer profiles, consultant profiles, and review systems.
- **NLP Research Projects** — Experimentation with pre-trained language models and LLMs as part of MSc research at King Khalid University.
- **Full-stack Web Applications** — Various Laravel + Vue/Livewire applications focused on clean architecture, REST conventions, and reactive UIs.

> 📌 Pinned repositories below showcase a selection of my recent work.

<h3 align="left">🏆 Achievements:</h3>

- 🎓 Pursuing **MSc in Computer Science** at King Khalid University
- 💼 Working professionally as a **Laravel Developer**
- 🧠 Active learner in **NLP, LLMs, and pre-trained models**
- 🧩 Active on **Codeforces** — sharpening problem-solving skills
- 🌍 Open-source contributor — building and maintaining Laravel-based projects
